...
<PropsTable {...props.data.searchField} />
<PropsTable {...props.data.searchFieldAdvanced} />
<PropsTable {...props.data.searchFieldLabel} />
<PropsTable {...props.data.searchFieldInput} />
