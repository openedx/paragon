...
```jsx live=true
<Collapsible title="Toggle Collapsible" styling="basic" >
...
```jsx live=true
<Collapsible title="I'm not a heading" styling="card">
    <p>Your stuff goes here.</p>
</Collapsible>
```

##### Default Collapsible with Heading

```jsx live=true
<Collapsible title="I'm a heading" styling="card-large">
    <p>Your stuff goes here.</p>
</Collapsible>
```
...
<Collapsible.Advanced className="collapsible-card">
  <Collapsible.Trigger className="collapsible-card-header collapsible-card-large d-flex align-items-center">
    <h5 className="flex-grow-1">I'm a heading</h5>

      <Collapsible.Visible whenClosed>
        <Icons.Plus className="collapsible-card-header-icon" />
      </Collapsible.Visible>

      <Collapsible.Visible whenOpen>
        <Icons.Minus className="collapsible-card-header-icon" />
      </Collapsible.Visible>
  </Collapsible.Trigger>
...
<Collapsible.Advanced className="collapsible-card" defaultOpen>
  ...
  <Collapsible.Body className="collapsible-card-body-large">
    <p>Your stuff goes here.</p>
  </Collapsible.Body>
</Collapsible.Advanced>
```
