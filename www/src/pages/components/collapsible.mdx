...
<PropsTable {...props.data.collapsible} />
<PropsTable {...props.data.collapsibleAdvanced} />
<PropsTable {...props.data.collapsibleTrigger} />
<PropsTable {...props.data.collapsibleBody} />
<PropsTable {...props.data.collapsibleVisible} />

export const query = graphql`
  query {
    collapsible: componentMetadata(displayName: { eq: "Collapsible" }) {
      ...ComponentDocGenData
    }
    collapsibleAdvanced: componentMetadata(displayName: { eq: "CollapsibleAdvanced" }) {
      ...ComponentDocGenData
    }
    collapsibleTrigger: componentMetadata(displayName: { eq: "CollapsibleTrigger" }) {
      ...ComponentDocGenData
    }
    collapsibleBody: componentMetadata(displayName: { eq: "CollapsibleBody" }) {
      ...ComponentDocGenData
    }
    collapsibleVisible: componentMetadata(displayName: { eq: "CollapsibleVisible" }) {
      ...ComponentDocGenData
    }
  }
`
