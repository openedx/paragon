    ...
    >
      ...
      >
        <FormGroup className="form-inline m-2">
          <FormLabel isInline className="font-weight-normal" htmlFor={`column-${index}-width`}>Width</FormLabel>
          <FormControl
        ...
        <FormGroup className="form-inline m-2">
          <FormLabel isInline className="font-weight-normal" htmlFor={`column-${index}-offset`}>Offset</FormLabel>
          <FormControl
            size="sm"
            type="number"
