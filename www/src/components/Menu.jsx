    ...
    <Container size="xl" className="py-5">
      <Row className="mb-5">
        <Col sm={3}>
          ...
          {FEATURES.ENABLE_PARAGON_PLAYGROUND && (
            <div className="pgn-doc menu__playground mb-5">
              <h3>
              ...
              <Button
                ...
                onClick={() => global.analytics.track('openedx.paragon.menu.visit_playground.clicked')}
                as={Link}
                to="/playground"
              >
                Visit playground
