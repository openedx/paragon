...
function LeaveFeedback(props) {
  ...
  const FEEDBACK_URL = `https://github.com/openedx/paragon/issues/new?title=%5Bparagon-openedx.netlify.app%5D%20Feedback%20(on%20${CURRENT_URL.pathname})&amp;labels=docs&template=feedback_template.md`;
