...
const MenuComponentList = ({ children, }) => <div className="menu-component-list">{children}</div>;
      ...
      <Row className="mb-5">
        <Col sm={3}>
          ...
          <ul className="list-unstyled small mb-4">
            <li><Link to="/guides/installation-and-usage">Installation and usage</Link></li>
            <li><a target="_blank" rel="noopener noreferrer" href="https://openedx.atlassian.net/wiki/spaces/BPL/pages/1773502564/Component+Contribution+Process">Contributing components</a></li>
            <li><a target="_blank" rel="noopener noreferrer" href="https://openedx.atlassian.net/wiki/spaces/BPL/overview">Design documentation</a></li>
            <li><a target="_blank" rel="noopener noreferrer" href="https://www.figma.com/file/eGmDp94FlqEr4iSqy1Uc1K/Paragon-2021">Paragon Figma library</a></li>
          </ul>
          ...
          <ul className="list-unstyled small mb-4">
            ...
            <li><Link to="/foundations/spacing">Spacing</Link></li>
            <li><Link to="/foundations/icons">Icons</Link></li>
            <li><Link to="/foundations/css-utilities">CSS Utility Classes</Link></li>
          </ul>
        </Col>
        <Col sm={9}>
        ...
        <MenuComponentList>
          {categories.map(({ fieldValue, nodes }) => (
            <MenuComponentListCategory key={fieldValue} title={fieldValue}>
              <ul className="list-unstyled small mb-4">
                {nodes.map(node => ({ key: node.id, ...node })).map(ComponentNavItem)}
              </ul>
