...
const messages = defineMessages({
  ...
  invalidSizeLess: {
    ...
    description: 'A message shown when a file with less than minimum allowed size is being uploaded,',
  },
  invalidSizeMore: {
    id: 'dropzone.Dropzone.invalidSizeMoreError',
    defaultMessage: 'File must be less than {size}.',
    description: 'A message shown when a file with more than maximum allowed size is being uploaded,',
  },
  invalidType: {
