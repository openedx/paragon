...
() => {
  ...
  return (
    <>
      ...
      >
        <p>I'm baby palo santo ugh celiac fashion axe. La croix lo-fi venmo whatever.</p>
      </AlertModal>
    </>
  );
};
...
() => {
  ...
  return (
    <>
      ...
      >
        <p>Are your sure you want to delete this file? You can't undo this action.</p>
      </AlertModal>
    </>
  );
};
