...
### Disable aria-hidden isolation

Setting `noIsolation` disables aria-hidden isolation, allowing users to interact with elements outside of the modal popup even when it is open. With one click, users can close the popup and continue interacting with the element beneath the cursor.
