...
() => {
  ...
  return (
    <>
      ...
      <ModalPopup hasArrow placement="right" positionRef={target} isOpen={isOpen} onClose={close}>
        <div className="bg-white p-3 rounded shadow border" style={{ textAlign: 'start' }}>
          <p>This could be a menu or tray.</p>
