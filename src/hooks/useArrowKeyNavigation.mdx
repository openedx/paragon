...
() => {
  ...
  return (
    <div ref={parentRef}>
      <Button className="mb-2 mb-sm-0" autoFocus>
        Brand
      </Button>{' '}
      <Button className="mb-2 mb-sm-0" variant="outline-brand">
        Outline Brand
      </Button>{' '}
      <Button className="mb-2 mb-sm-0" variant="outline-primary">
        Outline Primary
      </Button>{' '}
      <Button className="mb-2 mb-sm-0" variant="tertiary">
        Tertiary
      </Button>{' '}
    </div>
  );
