...
<Form.Group>
  ...
  <Form.Control.Feedback>We answer the important questions here.</Form.Control.Feedback>
</Form.Group>
```
...
<>
  <Form.Group>
    ...
    <Form.Control.Feedback>Let me help you!</Form.Control.Feedback>
  </Form.Group>
  ...
  <Form.Group>
    <Form.Control floatingLabel="What cats?" />
    <Form.Control.Feedback>More than one feedback at a time is possible.</Form.Control.Feedback>
    <Form.Control.Feedback type="valid">This is okay sometimes.</Form.Control.Feedback>
  </Form.Group>
</>
```
