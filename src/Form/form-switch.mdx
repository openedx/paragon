...
() => {
  const [isChecked, setChecked] = useState(false);
  const handleChange = (e) => setChecked(e.target.checked);
  return <SwitchControl checked={isChecked} onChange={handleChange} aria-label="Form switch" />;
};
```
...
<Form.Group>
  <Form.Label>Which Color?</Form.Label>
  <Form.SwitchSet name="color-two" onChange={(e) => console.log(e.target.value)} defaultValue={['green']}>
    <Form.Switch value="red">Red</Form.Switch>
    <Form.Switch value="green">Green</Form.Switch>
    <Form.Switch value="blue">Blue</Form.Switch>
    <Form.Switch value="cyan" disabled>
  ...
  return (
    <>
      <div className="d-flex">
        <Form.Switch checked={allChecked} isIndeterminate={isIndeterminate} onChange={handleCheckAllChange}>
          All the cheese
        </Form.Switch>
      </div>
      <Form.SwitchSet className="p-2" value={checkedCheeses} onChange={handleChange}>
...
<Form.Group>
  <Form.Label>Which Color?</Form.Label>
  <Form.SwitchSet name="color-three" onChange={(e) => console.log(e.target.value)} defaultValue={['green']} isInline>
    <Form.Switch value="red">Red</Form.Switch>
    <Form.Switch value="green">Green</Form.Switch>
    <Form.Switch value="blue">Blue</Form.Switch>
    <Form.Switch value="cyan" disabled>
...
<Form.Group>
  <Form.SwitchSet>
    <Form.Switch value="red" helperText={<span>Helper text for red switch</span>}>
      Red
    </Form.Switch>
    <Form.Switch value="blue" helperText={<span>Helper text for blue switch</span>}>
      Blue
    </Form.Switch>
  </Form.SwitchSet>
</Form.Group>
