...
() => {
  ...
  return (
    <Form.Checkbox checked={isChecked} onChange={handleChange} screenReaderText="Checkbox">
      I want pizza.
    </Form.Checkbox>
  );
}
  ...
  return (
    <Form.Group>
      ...
      <Form.CheckboxSet
        ...
        value={colorValues}
      >
        <Form.Checkbox value="red" screenReaderText="Checkbox">Red</Form.Checkbox>
        <Form.Checkbox value="green" screenReaderText="Checkbox">Green</Form.Checkbox>
        <Form.Checkbox value="blue" screenReaderText="Checkbox">Blue</Form.Checkbox>
        <Form.Checkbox value="cyan" screenReaderText="Checkbox" disabled>Cyan</Form.Checkbox>
      </Form.CheckboxSet>
    </Form.Group>
  );
}
  ...
  return (
    <>
      ...
      <Form.CheckboxSet
        ...
        onChange={handleChange}
      >
        <Form.Checkbox value="swiss" screenReaderText="Checkbox">Swiss</Form.Checkbox>
        <Form.Checkbox value="cheddar" screenReaderText="Checkbox">Cheddar</Form.Checkbox>
        <Form.Checkbox value="pepperjack" screenReaderText="Checkbox">Pepperjack</Form.Checkbox>
      </Form.CheckboxSet>
    </>
  );
}
...
<Form.Group>
  <Form.CheckboxSet>
    <Form.Checkbox value="red" screenReaderText="Checkbox" floatLabelLeft>Red</Form.Checkbox>
  </Form.CheckboxSet>
</Form.Group>
```
