...
The following example demonstrates how to use `OverflowScroll`, `OverflowScroll.Items`, `OverflowScroll.StartSentinel`, and `OverflowScroll.EndSentinel` to build carousel-like UI components.
