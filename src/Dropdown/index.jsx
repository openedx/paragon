  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div className={this.state.open ? 'dropdown-menu show' : 'dropdown-menu'} aria-label={buttonContent} aria-hidden={!open} role="menu" ref={this.menuItems} onKeyDown={this.handleMenuKeyDown}>
          {this.props.children}
        </div>
      </div>
    );
