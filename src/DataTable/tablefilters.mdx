...
<dl>
  <dt>text</dt>
  <dd>
    This is the default filter function. It lower-cases the search string and
    checks if the row value includes the search string
  </dd>
  <dt>exactText</dt>
  <dd>
    Checks that the row value matches the search string exactly
    (case-insensitive)
  </dd>
  <dt>exactTextCase</dt>
  <dd>
  ...
  <dt>between</dt>
  <dd>
    Expects an array with a min and max value as the search term. Checks that
    the row value is between the min and max
  </dd>
</dl>
