...
```jsx live
<>
  <Button variant="primary" className="mr-2" screenReaderText="Spinner">
    <Spinner animation="border" screenReaderText="loading some stuff" />
  </Button>
  <Button variant="brand" className="mr-2" screenReaderText="Spinner">
    <Spinner animation="border" />
  </Button>
  <Button variant="outline-primary" className="mr-2" screenReaderText="Spinner">
    <Spinner animation="border" />
  </Button>
  <Button variant="outline-brand" className="mr-2" screenReaderText="Spinner">
    <Spinner animation="border" />
  </Button>
  <Button variant="inverse-primary" className="mr-2" screenReaderText="Spinner">
    <Spinner animation="border" />
  </Button>
  <Button variant="inverse-brand" className="mr-2" screenReaderText="Spinner">
    <Spinner animation="border" />
  </Button>
</>
```
