(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["excalibur"] = factory(require("react"), require("react-addons-css-transition-group"), require("react-addons-transition-group"), require("react-dom"));
	else
		root["excalibur"] = factory(root["React"], root["React"]["addons"]["CSSTransitionGroup"], root["React"]["addons"]["TransitionGroup"], root["ReactDOM"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_18__, __WEBPACK_EXTERNAL_MODULE_19__, __WEBPACK_EXTERNAL_MODULE_20__) {
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:!0});var lastId=0,newId=exports.newId=function(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:'id';return lastId++,''+a+lastId};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_addons_transition_group__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_react_addons_css_transition_group__ = __webpack_require__(18);
...
"use strict";
var _createClass=function(){function a(b,c){for(var e,d=0;d<c.length;d++)e=c[d],e.enumerable=e.enumerable||!1,e.configurable=!0,'value'in e&&(e.writable=!0),Object.defineProperty(b,e.key,e)}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),_react=__webpack_require__(1),_react2=_interopRequireDefault(_react),_reactstrap=__webpack_require__(6),_classnames=__webpack_require__(13),_classnames2=_interopRequireDefault(_classnames),_propTypes=__webpack_require__(5),_propTypes2=_interopRequireDefault(_propTypes),_utils=__webpack_require__(2);Object.defineProperty(exports,'__esModule',{value:!0});function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError('Cannot call a class as a function')}function _possibleConstructorReturn(a,b){if(!a)throw new ReferenceError('this hasn\'t been initialised - super() hasn\'t been called');return b&&('object'==typeof b||'function'==typeof b)?b:a}function _inherits(a,b){if('function'!=typeof b&&null!==b)throw new TypeError('Super expression must either be null or a function, not '+typeof b);a.prototype=Object.create(b&&b.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0}}),b&&(Object.setPrototypeOf?Object.setPrototypeOf(a,b):a.__proto__=b)}var TabInterface=function(a){function b(c){_classCallCheck(this,b);var d=_possibleConstructorReturn(this,(b.__proto__||Object.getPrototypeOf(b)).call(this,c));return d.toggle=d.toggle.bind(d),d.state={activeTab:0,uuid:(0,_utils.newId)('tabInterface')},d}return _inherits(b,a),_createClass(b,[{key:'toggle',value:function toggle(c){this.state.activeTab!==c&&this.setState({activeTab:c})}},{key:'genLabelId',value:function genLabelId(c){return'tab-label-'+this.state.uuid+'-'+c}},{key:'genPanelId',value:function genPanelId(c){return'tab-panel-'+this.state.uuid+'-'+c}},{key:'buildLabels',value:function buildLabels(){var c=this;return this.props.tabLabels.map(function(d,e){var f=c.state.activeTab===e;return _react2.default.createElement(_reactstrap.NavItem,{'aria-selected':f,'aria-controls':c.genPanelId(e),id:c.genLabelId(e),key:e,role:'tab',tabIndex:f?0:-1},_react2.default.createElement(_reactstrap.NavLink,{className:(0,_classnames2.default)({active:f}),onClick:function onClick(){c.toggle(e)}},d))})}},{key:'buildPanels',value:function buildPanels(){var c=this;return this.props.panels.map(function(d,e){var f=c.state.activeTab===e;return _react2.default.createElement(_reactstrap.TabPane,{'aria-hidden':!f,'aria-labelledby':c.genLabelId(e),id:c.genPanelId(e),key:e,role:'tabpanel',tabId:e},d)})}},{key:'render',value:function render(){var c=this.buildLabels(),d=this.buildPanels();return _react2.default.createElement('div',{className:this.props.className},_react2.default.createElement(_reactstrap.Nav,{tabs:!0,role:'tablist'},c),_react2.default.createElement(_reactstrap.TabContent,{activeTab:this.state.activeTab},d))}}]),b}(_react2.default.Component);TabInterface.propTypes={tabLabels:_propTypes2.default.array.isRequired,panels:_propTypes2.default.array.isRequired},exports.default=TabInterface;
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:!0}),exports.TextInput=exports.TabInterface=exports.SelectInput=void 0;var _SelectInput=__webpack_require__(9),_SelectInput2=_interopRequireDefault(_SelectInput),_TabInterface=__webpack_require__(10),_TabInterface2=_interopRequireDefault(_TabInterface),_TextInput=__webpack_require__(11),_TextInput2=_interopRequireDefault(_TextInput);function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}exports.SelectInput=_SelectInput2.default,exports.TabInterface=_TabInterface2.default,exports.TextInput=_TextInput2.default;
