(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("react-addons-css-transition-group"), require("react-addons-transition-group"), require("react-dom"));
	else if(typeof define === 'function' && define.amd)
		define(["react", "react-addons-css-transition-group", "react-addons-transition-group", "react-dom"], factory);
	else if(typeof exports === 'object')
		exports["paragon"] = factory(require("react"), require("react-addons-css-transition-group"), require("react-addons-transition-group"), require("react-dom"));
	else
		root["paragon"] = factory(root["React"], root["React"]["addons"]["CSSTransitionGroup"], root["React"]["addons"]["TransitionGroup"], root["ReactDOM"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_19__, __WEBPACK_EXTERNAL_MODULE_20__, __WEBPACK_EXTERNAL_MODULE_21__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_addons_transition_group__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_react_addons_css_transition_group__ = __webpack_require__(19);
...
"use strict";
var _extends=Object.assign||function(a){for(var c,b=1;b<arguments.length;b++)for(var d in c=arguments[b],c)Object.prototype.hasOwnProperty.call(c,d)&&(a[d]=c[d]);return a},_createClass=function(){function a(b,c){for(var e,d=0;d<c.length;d++)e=c[d],e.enumerable=e.enumerable||!1,e.configurable=!0,'value'in e&&(e.writable=!0),Object.defineProperty(b,e.key,e)}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),_react=__webpack_require__(1),_react2=_interopRequireDefault(_react),_propTypes=__webpack_require__(5),_propTypes2=_interopRequireDefault(_propTypes),_reactstrap=__webpack_require__(2),_newId=__webpack_require__(7),_newId2=_interopRequireDefault(_newId);Object.defineProperty(exports,'__esModule',{value:!0}),exports.inputProps=void 0;function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError('Cannot call a class as a function')}function _possibleConstructorReturn(a,b){if(!a)throw new ReferenceError('this hasn\'t been initialised - super() hasn\'t been called');return b&&('object'==typeof b||'function'==typeof b)?b:a}function _inherits(a,b){if('function'!=typeof b&&null!==b)throw new TypeError('Super expression must either be null or a function, not '+typeof b);a.prototype=Object.create(b&&b.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0}}),b&&(Object.setPrototypeOf?Object.setPrototypeOf(a,b):a.__proto__=b)}var getDisplayName=function(a){return a.displayName||a.name||'Component'},inputProps=exports.inputProps={label:_propTypes2.default.string.isRequired,name:_propTypes2.default.string.isRequired,value:_propTypes2.default.string,description:_propTypes2.default.oneOfType([_propTypes2.default.string,_propTypes2.default.element]),disabled:_propTypes2.default.bool,required:_propTypes2.default.bool,onChange:_propTypes2.default.func,onBlur:_propTypes2.default.func,validator:_propTypes2.default.func},asInput=function(a){var b=function(c){function d(e){_classCallCheck(this,d);var f=_possibleConstructorReturn(this,(d.__proto__||Object.getPrototypeOf(d)).call(this,e));f.handleChange=f.handleChange.bind(f),f.handleBlur=f.handleBlur.bind(f);var g=(0,_newId2.default)('textInput');return f.state={id:g,value:f.props.value,isValid:!0,describedBy:[],errorId:'error-'+g,descriptionId:'description-'+g},f}return _inherits(d,c),_createClass(d,[{key:'getDescriptions',value:function getDescriptions(){var e='error-'+this.state.id,f='description-'+this.state.id,g={};return this.state.isValid||(g.error=_react2.default.createElement(_reactstrap.FormFeedback,{id:e,key:'0'},this.state.validationMessage),g.describedBy=e),this.props.description&&(g.description=_react2.default.createElement(_reactstrap.FormText,{id:f,key:'1'},this.props.description),g.describedBy=(g.describedBy+' '+f).trim()),g}},{key:'handleBlur',value:function handleBlur(e){var f=e.target.value;this.props.validator&&this.setState(this.props.validator(f)),this.props.onBlur(f,this.props.name)}},{key:'handleChange',value:function handleChange(e){this.setState({value:e.target.value}),this.props.onChange(e.target.value,this.props.name)}},{key:'render',value:function render(){var e=this.getDescriptions(),f=e.description,g=e.error,h=e.describedBy;return _react2.default.createElement(_reactstrap.FormGroup,null,_react2.default.createElement(_reactstrap.Label,{'for':this.state.id},this.props.label),_react2.default.createElement(a,_extends({},this.props,this.state,{describedBy:h,onChange:this.handleChange,onBlur:this.handleBlur})),g,f)}}]),d}(_react2.default.Component);return b.displayName='asInput('+getDisplayName(a)+')',b.propTypes=inputProps,b.defaultProps={onChange:function onChange(){},onBlur:function onBlur(){},value:'',description:void 0,disabled:!1,required:!1,validator:void 0},b};exports.default=asInput;
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:!0});var lastId=0,newId=function(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:'id';return lastId+=1,''+a+lastId};exports.default=newId;
...
"use strict";
var _extends=Object.assign||function(a){for(var c,b=1;b<arguments.length;b++)for(var d in c=arguments[b],c)Object.prototype.hasOwnProperty.call(c,d)&&(a[d]=c[d]);return a},_createClass=function(){function a(b,c){for(var e,d=0;d<c.length;d++)e=c[d],e.enumerable=e.enumerable||!1,e.configurable=!0,'value'in e&&(e.writable=!0),Object.defineProperty(b,e.key,e)}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),_react=__webpack_require__(1),_react2=_interopRequireDefault(_react),_reactstrap=__webpack_require__(2),_propTypes=__webpack_require__(5),_propTypes2=_interopRequireDefault(_propTypes),_asInput=__webpack_require__(6),_asInput2=_interopRequireDefault(_asInput);Object.defineProperty(exports,'__esModule',{value:!0});function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError('Cannot call a class as a function')}function _possibleConstructorReturn(a,b){if(!a)throw new ReferenceError('this hasn\'t been initialised - super() hasn\'t been called');return b&&('object'==typeof b||'function'==typeof b)?b:a}function _inherits(a,b){if('function'!=typeof b&&null!==b)throw new TypeError('Super expression must either be null or a function, not '+typeof b);a.prototype=Object.create(b&&b.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0}}),b&&(Object.setPrototypeOf?Object.setPrototypeOf(a,b):a.__proto__=b)}var Select=function(a){function b(){return _classCallCheck(this,b),_possibleConstructorReturn(this,(b.__proto__||Object.getPrototypeOf(b)).apply(this,arguments))}return _inherits(b,a),_createClass(b,[{key:'getOptions',value:function getOptions(){return this.props.options.map(function(c,d){var e;if(c.options){var f=c.options.map(function(g,h){return b.getOption(g,h)});e=_react2.default.createElement('optgroup',{label:c.label,key:c.label},f)}else e=b.getOption(c,d);return e})}},{key:'render',value:function render(){var c=_extends({},this.props),d=this.getOptions();return _react2.default.createElement(_reactstrap.Input,{id:c.id,type:'select',name:c.name,value:c.value,'aria-describedby':c.describedBy,onChange:c.onChange,onBlur:c.onBlur},d)}}],[{key:'getOption',value:function getOption(c,d){var e=c.label,f=c.value;return'string'==typeof c&&(e=c,f=c),_react2.default.createElement('option',{value:f,key:'option-'+d},e)}}]),b}(_react2.default.Component);Select.propTypes=_extends({},_asInput.inputProps,{options:_propTypes2.default.oneOfType([_propTypes2.default.arrayOf(_propTypes2.default.string),_propTypes2.default.arrayOf(_propTypes2.default.object)]).isRequired});var SelectInput=(0,_asInput2.default)(Select);SelectInput.propTypes=_extends({},SelectInput.propTypes,Select.propTypes),exports.default=SelectInput;
...
"use strict";
var _createClass=function(){function a(b,c){for(var e,d=0;d<c.length;d++)e=c[d],e.enumerable=e.enumerable||!1,e.configurable=!0,'value'in e&&(e.writable=!0),Object.defineProperty(b,e.key,e)}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),_react=__webpack_require__(1),_react2=_interopRequireDefault(_react),_reactstrap=__webpack_require__(2),_classnames=__webpack_require__(14),_classnames2=_interopRequireDefault(_classnames),_propTypes=__webpack_require__(5),_propTypes2=_interopRequireDefault(_propTypes),_newId=__webpack_require__(7);Object.defineProperty(exports,'__esModule',{value:!0});function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError('Cannot call a class as a function')}function _possibleConstructorReturn(a,b){if(!a)throw new ReferenceError('this hasn\'t been initialised - super() hasn\'t been called');return b&&('object'==typeof b||'function'==typeof b)?b:a}function _inherits(a,b){if('function'!=typeof b&&null!==b)throw new TypeError('Super expression must either be null or a function, not '+typeof b);a.prototype=Object.create(b&&b.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0}}),b&&(Object.setPrototypeOf?Object.setPrototypeOf(a,b):a.__proto__=b)}var TabInterface=function(a){function b(c){_classCallCheck(this,b);var d=_possibleConstructorReturn(this,(b.__proto__||Object.getPrototypeOf(b)).call(this,c));return d.toggle=d.toggle.bind(d),d.state={activeTab:0,uuid:(0,_newId.newId)('tabInterface')},d}return _inherits(b,a),_createClass(b,[{key:'toggle',value:function toggle(c){this.state.activeTab!==c&&this.setState({activeTab:c})}},{key:'genLabelId',value:function genLabelId(c){return'tab-label-'+this.state.uuid+'-'+c}},{key:'genPanelId',value:function genPanelId(c){return'tab-panel-'+this.state.uuid+'-'+c}},{key:'buildLabels',value:function buildLabels(){var c=this;return this.props.tabLabels.map(function(d,e){var f=c.state.activeTab===e,g=c.genLabelId(e);return _react2.default.createElement(_reactstrap.NavItem,{'aria-selected':f,'aria-controls':c.genPanelId(e),id:g,key:g,role:'tab',tabIndex:f?0:-1},_react2.default.createElement(_reactstrap.NavLink,{className:(0,_classnames2.default)({active:f}),onClick:function onClick(){c.toggle(e)}},d))})}},{key:'buildPanels',value:function buildPanels(){var c=this;return this.props.panels.map(function(d,e){var f=c.state.activeTab===e,g=c.genPanelId(e);return _react2.default.createElement(_reactstrap.TabPane,{'aria-hidden':!f,'aria-labelledby':c.genLabelId(e),id:g,key:g,role:'tabpanel',tabId:e},d)})}},{key:'render',value:function render(){var c=this.buildLabels(),d=this.buildPanels();return _react2.default.createElement('div',null,_react2.default.createElement(_reactstrap.Nav,{tabs:!0,role:'tablist'},c),_react2.default.createElement(_reactstrap.TabContent,{activeTab:this.state.activeTab},d))}}]),b}(_react2.default.Component);TabInterface.propTypes={tabLabels:_propTypes2.default.oneOfType([_propTypes2.default.arrayOf(_propTypes2.default.String),_propTypes2.default.arrayOf(_propTypes2.default.Element)]).isRequired,panels:_propTypes2.default.arrayOf(_propTypes2.default.Element).isRequired},exports.default=TabInterface;
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:!0});var _react=__webpack_require__(1),_react2=_interopRequireDefault(_react),_reactstrap=__webpack_require__(2),_asInput=__webpack_require__(6),_asInput2=_interopRequireDefault(_asInput);function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}function TextField(a){return _react2.default.createElement(_reactstrap.Input,{id:a.id,type:'text',name:a.name,value:a.value,placeholder:a.placeholder,'aria-describedby':a.describedBy,onChange:a.onChange,onBlur:a.onBlur,'aria-invalid':!a.isValid,disabled:a.disabled,required:a.required,state:a.inputState})}TextField.propTypes=_asInput.inputProps;var TextInput=(0,_asInput2.default)(TextField);exports.default=TextInput;
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:!0}),exports.TextInput=exports.TabInterface=exports.SelectInput=void 0;var _SelectInput=__webpack_require__(10),_SelectInput2=_interopRequireDefault(_SelectInput),_TabInterface=__webpack_require__(11),_TabInterface2=_interopRequireDefault(_TabInterface),_TextInput=__webpack_require__(12),_TextInput2=_interopRequireDefault(_TextInput);function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}exports.SelectInput=_SelectInput2.default,exports.TabInterface=_TabInterface2.default,exports.TextInput=_TextInput2.default;
...
//# sourceMappingURL=paragon.min.js.map